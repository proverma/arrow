...
TestExecutor.prototype.runNextTest = function(testQueue) {
    ...
    testSession.runTest(function (error) {
        ...
        testSessionTimeArr[thisSession.args.testName].timeTaken = ((thisSession.endTime - self.startTime) / 1000).toFixed(2);
        sf.timeReportObj[thisSession.descriptorPath].testSessionTimeArr = testSessionTimeArr;

        testExecutor.logger.info('Time taken to run - ' + self.descriptorPath + '-' + thisSession.args.testName + ' is::' +
