...
SessionFactory.prototype.getFactoryTests = function () {
    ...
    for (i = 0; i < this.arrDescriptor.length; i += 1) {
        ...
        console.log('****For the descriptor 2 -  ' + this.descriptorObj[descFile] + ', browser :' + this.browser);
        if (this.browser) {
...
//        this.descLib = "";
        ...
        for (testName in dp) {
            ...
            console.log('****For the descriptor 2 -  ' + testData.descriptorPath + ' : browser: ' + testData.browser);
