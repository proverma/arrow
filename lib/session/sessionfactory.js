...
//            console.log('****-Sessionfactory-Relative Path for ' + descFile + ' :::' + testData.relativePath);
            ...
            //TODO - ReportFolder is common to all testsessions , so it shall not be part of each testsession
            // Review & change - where to store "reportFolder" value so testsession(s) can access it
            testData.reportFolder = this.reportFolder;
