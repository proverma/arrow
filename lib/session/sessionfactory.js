...
SessionFactory.prototype.getFactoryTests = function () {
    ...
    console.log('*****this.arrDescriptor.length::' + this.arrDescriptor.length);
...
//        this.descLib = "";
        ...
        for (testName in dp) {
            ...
            console.log('*****Iterating testName::' + testName);
            ...
            console.log('*****Iterating testName 10');
            ...
            console.log('*****Iterating testName 11');
            // Initialize the share area
            testData.params.shared = {};

            console.log('*****Pushing testName::' + testName);
            tests.push(testData);

            console.log('After testName ' + testName + ' ,test length :' + tests.length);
