...
//    console.log('\n\n****-In getFactoryTests..');
    ...
    for (i = 0; i < this.arrDescriptor.length; i += 1) {
        ...
        // TODO : Pranav , Remove this as proxy properties should no longer be part of sessionfactory
...
//            console.log('****No Common Lib found..');
        }
...
//    console.log("****-SessionFactory:TearDown: testSuiteName-" + this.testSuiteName);
    ...
    if (this.args.report && testQueue.sessions) {
        ...
        reportManager.totalTimeTaken = ((Date.now() - global.startTime) / 1000).toFixed(2);
