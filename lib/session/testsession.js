...
function TestSession(config, args, sessionId) {
    ...
    if (args.descriptorName) {
        this.descriptorName = args.descriptorName;
    }
...
/**
 *
 * @param artifactsObj : fields - testName ,count , descriptorName , reportDir , screenShotsDir , artifactsUrl
...
TestSession.prototype.getArtifactPaths = function (artifactsObj){
    ...
    try {
        ...
        dirPath = artifactsObj.descriptorName ? artifactsObj.descriptorName : "";
        ...
        if (artifactsObj.artifactsUrl) {
            ...
            artifactPaths.pngPath = artifactsObj.artifactsUrl + path.sep + path.join(screenShotsPath, artifactsObj.descriptorName, screenShotImgPath);
            artifactPaths.pngPath = encodeURI(artifactPaths.pngPath);

            artifactPaths.htmlPath = artifactsObj.artifactsUrl + path.sep + path.join(screenShotsPath, artifactsObj.descriptorName, screenShotHtmlPath);
...
TestSession.prototype.recordFailure = function (count, callback) {
    ...
    try {
        ...
        artifactsObj.descriptorName = self.descriptorName;
