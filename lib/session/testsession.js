...
function TestSession(config, args, sessionId) {
    ...
    this.startTime = 0;
    this.endTime = 0;
//    console.log('***TestSession Constructor..' + args.resolvedRouterConfigPath);
...
//    console.log('***TestSession Constructor..' + this.resolvedRouterConfigPath);

}

TestSession.prototype.setup = function (callback) {
    var DriverClass = null;
//    console.log('***In testsession setup 1');
    if (!this.driverName) {
//        console.log('***In testsession setup 2');
        if (this.controller || this.testParams.page || this.args.browser || this.sessionId) {
            console.log('***In testsession setup 3');
            this.driverName = "selenium";
        } else {
            this.driverName = "nodejs";
        }
//        console.log('***In testsession setup 4');
    }
//    console.log('***In testsession setup 5');
...
//    console.log('***In testsession setup 6');
    this.logger.debug("driver: " + this.driver + ", browser: " + this.args.browser);
//    console.log('***In testsession setup 7');
...
//    console.log('***In testsession setup 8');
//    console.log('****In setup...' + this.resolvedRouterConfigPath);
//    console.log('****In setup...' + global.routerMap[this.resolvedRouterConfigPath]);
    if (this.resolvedRouterConfigPath) {
        this.config.proxyUrl = global.routerMap[this.resolvedRouterConfigPath];
    }
//    console.log('***In testsession setup 9');
    this.driver = new DriverClass(this.config, this.args);
//    console.log('***In testsession setup 10');
    this.driver.setSessionId(this.sessionId);
//    console.log('***In testsession setup 11');
...
//    console.log('\n\n\n****-In testSession..now running test:' + this.args.testName + '\n\n');
...
//        console.log('****TestSession...Returning now');
        return;
    });
...
//        console.log('**** - In testsession, test over::' + self.args.testName + ",descriptor::" + self.descriptorPath);
