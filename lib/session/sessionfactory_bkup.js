...
//    console.log('****In sessionfactory constructor reusesession...' + this.reuseSession);
...
//    console.log('****In sessionfactory constructor browser...' + this.browser);
...
//        console.log('****-SessionFactory - For descriptor - ' + descFile + ' ...testSuiteName : ' + this.testSuiteName);
        dp = testJson.dataprovider;

        commonLib =  testJson.commonlib;
//        console.log('****-SessionFactory - Common Lib - ' + commonLib);
...
//        this.descLib = "";
//        console.log('****-In sessionfactory,Common Lib:: ' + commonLib);
        if (commonLib) {
//            console.log('****Common Lib found..so calling getTest..' + relativePath);
...
//                console.log('*****TestData params lib::' + testData.params.lib + ',Relative Path::' + relativePath);
...
//            console.log('****-Sessionfactory-Descfile Path for ' + descFile);
            testData.relativePath = descFile.substring(0, descFile.lastIndexOf(global.pathSep));
//            console.log('****-Sessionfactory-Relative Path for ' + descFile + ' :::' + testData.relativePath);
...
//    console.log('                             Detailed Report                                          \n');
    ...
    var timeReportJsonStr = "{ \"descriptors\" : ";

    for (descriptor in this.timeReportObj) {

        timeReportJsonStr += "[";
        detailedReport += ('\n\nFor descriptor - ' + descriptor);
        timeReportJsonStr += ("\"descriptor\":" + descriptor + ",");
        timeReportJsonStr += ("\"time\":" + this.timeReportObj[descriptor].timeTaken + " seconds ,");

//        console.log('\nFor descriptor - ' + descriptor);

        detailedReport += ('\n\tTime taken = ' + this.timeReportObj[descriptor].timeTaken + ' seconds');
//        console.log('\tTime taken = ' + this.timeReportObj[descriptor].timeTaken + ' seconds');

        testSessionTimeArr = this.timeReportObj[descriptor].testSessionTimeArr;
        ...
        for (testName in testSessionTimeArr) {
            ...
            detailedReport += ('\n\t\tTime taken by test:' + testName + ' = ' + testSessionTimeArr[testName].timeTaken + ' seconds');
//            console.log('\t\tTime taken by test:' + testName + ' = ' + testSessionTimeArr[testName].timeTaken + ' seconds');
            timeReportJsonStr += '},';
        }
    ...
    timeReportJsonStr += ("\"Total time\":" + totalTimeTaken + " seconds");
    timeReportJsonStr += "}";
    detailedReport += ('\n\nTotal Time taken :' + totalTimeTaken + ' seconds');
//    console.log('\nTotal Time taken :' + totalTimeTaken + ' seconds');
//    console.log(JSON.stringify(detailedReport));
    console.log(JSON.stringify(timeReportJsonStr));
    console.log('*************************************************************************************\n');
