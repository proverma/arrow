...
var SHARE_LIB_DIR_PREFIX = arrowConfig.scanModulesPrefix || ["martini_"];
 ...
 * that 's modules(folder) start with "martini_" or "" or is just build-in lib : arrow/sharelib/
 ...
 * @param libname libname start with martini_ or
 */
