...
//    console.log('****-In libmanager:' + this.strLibPath);
//    console.log('****-In libmanager, relativePath:' + relativePath);
    this.logger.trace("Normalizing libs: " + strLibPath);
    arrLib = this.strLibPath.split(",");
    console.log('****-In libmanager, after split:' + arrLib[0]);
    for (i = 0; i < arrLib.length; i += 1) {
        try {
            ...
            console.log('****Resolved path for lib:' + arrLib[i]);
