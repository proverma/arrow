...
//        console.log('\n\n******relativePath::' + relativePath);
        ...
        for (var i = 0; i < importedDescriptorArr.length; i+=1) {
            ...
            importedDescriptorJsonStr = fs.readFileSync(path.join(cwd, descriptorJson[0].importDescriptor[i].path), "utf-8");
//            console.log('\n\n******importedDescriptorJsonStr::' + importedDescriptorJsonStr);
...
//            console.log('\n\n****DescriptorJson::' + descriptorJson[0]);
...
//            console.log('\n\n***ImportJson::' + JSON.stringify(importJson));
            ...
            if (commonLib) {
                ...
                newCommonLib = newCommonLib.substring(1,newCommonLib.length-1);
                console.log('\n\nnewCommonLib:::' + newCommonLib);
//                testObj.commonlib = newCommonLib;
