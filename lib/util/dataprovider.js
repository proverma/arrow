...
DataProvider.prototype.processImportDescriptor = function(descriptorJson) {
    ...
    try {
//        console.log('****testDataPath::' + self.testDataPath + '\n');

//        console.log('****relativePath XX::' + self.testDataPath.substring(0, self.testDataPath.lastIndexOf(global.pathSep)) + '\n');
        relativePath = self.testDataPath.substring(0, self.testDataPath.lastIndexOf(pathSep));
...
//            console.log('****global.workingDirectory :: ' + cwd);
//            console.log('****relativePath :: ' + relativePath);
//            console.log('****descriptorJson[0].importDescriptor[i].path :: ' + descriptorJson[0].importDescriptor[i].path);
            importedDescriptorJsonStr = fs.readFileSync(path.resolve(cwd, relativePath, descriptorJson[0].importDescriptor[i].path), "utf-8");
