...
//                console.log('\n\nCloned Descriptor ::' + JSON.stringify(descJson));
...
DataProvider.prototype.getDescriptor = function(descriptorJson) {
    ...
    var importDescriptor = descriptorJson[0].importDescriptor,
        ...
        self = this,
        descriptor,
        relativePath = path.dirname(this.testDataPath);
    ...
    descriptorJson = self.extendDescriptor(descriptorJson, cwd, relativePath);

//    If data driven, merge config object from data provider
//    if (self.isDataDriven && self.context) {
//        self.overrideDataProviderConfig(descriptorJson);
//    }
...
// * @param descriptorJson
// */
//DataProvider.prototype.overrideDataProviderConfig = function(descriptorJson) {
//
//    var pos,
//        self = this,
//        settings;
...
//    for (pos = 0; pos < descriptorJson.length; pos += 1) {
//
//        settings = JSON.stringify(descriptorJson[pos].settings[0]);
//        if (settings && self.context) {
//            if (settings === JSON.stringify(self.context)) {
//                console.log('\n***Overriding ' + settings + ', pos ::' + pos);
//                console.log('***descriptorJson ' + JSON.stringify(descriptorJson) + '\n\n');
//                _.extend(descriptorJson[pos].config, descriptorJson[0].config);
 ...
 * @param relativePath
 */
DataProvider.prototype.extendDescriptor = function(descriptorJson, cwd, relativePath) {
