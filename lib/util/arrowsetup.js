...
ArrowSetup.prototype.setup = function () {
    this.setuplog4js();
    this.deleteOldFiles(); // TODO - Tests get stuck here when run from outside e.g arrow 'arrow_test/tests/descriptor*.json' fails
...
ArrowSetup.prototype.setupHeadlessParam = function () {
    ...
    if (".json" === ext) {
        ...
        // Store .json files in arrDescriptor - Added
