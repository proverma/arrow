...
engineManager.prototype.getEngineSeed = function () {
    return path.join(this.config['arrowModuleRoot'], "lib/engine/interface/engine-seed.js");
};
/**
...
engineManager.prototype.getEngineRunner = function () {
    return path.join(this.config['arrowModuleRoot'], "lib/engine/interface/engine-runner.js");
};
/**
...
engineManager.prototype.getTestSeed = function (engineName) {
    ...
    return self.config['testSeed'] || path.join(self.config['arrowModuleRoot'], "lib/engine/yuitest/yuitest-seed.js"); //default seed
};
/**
...
engineManager.prototype.getTestRunner = function (engineName) {
    ...
    return self.config['testRunner'] || path.join(self.config['arrowModuleRoot'], "lib/engine/yuitest/yuitest-runner.js");  //default runner
};
    ...
    if (typeof configjson === "string") {
        try {// it is a path
            ...
            try {
                ...
                this.logger.debug("Please confirm the config file " + configjson + " exist and is json formart");
                return {};
            }
        } catch (e) {
            // no such file
            try {
                ...
                this.logger.debug("Please confirm the config string " + configjson + " exist and is json formart");
                return {};
            }
        }
