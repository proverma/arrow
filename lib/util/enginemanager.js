...
engineManager.prototype.getEngineSeed = function () {
    return require(this.config.arrowModuleRoot + "lib/engine/interface/engine-seed.js");
};
/**
...
engineManager.prototype.getEngineRunner = function () {
    return require(this.config.arrowModuleRoot + "lib/engine/interface/engine-runner.js");
};
/**
