    ...
    if (typeof configjson === "string") {
        try {// it is a path
            ...
            try {
                ...
                this.logger.trace("Please confirm the config file " + configjson + " exist and is json format");
                return {};
            }
        } catch (e) {
            // no such file
            try {
                ...
                this.logger.trace("Please confirm the config string " + configjson + " exist and is json format");
                return {};
            }
        }
        ...
        this.logger.error("Please confirm the config " + configjson + " is object or json format file/string");
        return {};
    }
};
