...
engineManager.prototype.getTestSeed = function (engineName) {
    ...
    return  path.join(self.config['arrowModuleRoot'],"lib/engine/yuitest/yuitest-seed.js"); //default seed
};
/**
...
engineManager.prototype.getTestRunner = function (engineName) {
    ...
    return path.join(self.config['arrowModuleRoot'],"lib/engine/yuitest/yuitest-runner.js");  //default runner
};
