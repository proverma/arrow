...
//        console.log('****ReportObj descriptor::' + this.reportObj.descriptor);
        reportFilePath = this.reportObj.descriptor.substring(this.reportObj.descriptor.lastIndexOf(global.pathSep) + 1);
...
//    console.log('****-Report folder::' + self.reportFolder);
    ...
    xmlReportName = path.resolve(self.reportFolder, xmlReportName);
    jsonReportName = path.resolve(self.reportFolder, jsonReportName);
