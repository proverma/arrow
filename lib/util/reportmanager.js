...
ReportManager.prototype.writeReports = function () {
    ...
    for (i = 0; i < testSessions.length; i = i + 1) {
        ...
        console.log('In reportmanager..' + i + ', ' + JSON.stringify(rep));
    ...
    xmlReportName = "arrowTests-report.xml";
    jsonReportName = "arrowTests-report.json";
    ...
    if (self.reportFolder) {
        ...
        reportDirPath = global.workingDirectory + "/arrow-target"; //TODO - Reports should go under "arrow-target/reports" directory
        ...
        xmlReportName = reportDirPath + "/arrowTests-report.xml";
        jsonReportName = reportDirPath + "/arrowTests-report.json";
    }
