...
ReportManager.prototype.writeReports = function () {
    ...
    function addTest(time, className, name, failureMessage) {
        ...
        xw.writeAttribute('time', (time / 1000).toFixed(2));
        xw.writeAttribute('classname', className);
        xw.writeAttribute('name', name);
    ...
    log();
    log(("Total Number of Executed Tests: " + totalCount).blue.toString());
    log(("Total Number of Passed Tests: " + passCount).green.toString());
    log(("Total Number of Failed Tests: " + failCount).red.toString());
    log(("Total Number of Skipped Tests: " + skipCount).cyan.toString());
    log();
    log(("Total Test Execution Time Inside Browser: " + (timeCount / 1000).toFixed(2) + " seconds").green.bold.toString());
    totalTimeTaken = Date.now() - global.startTime;
    log(("Total Test Execution Time:" + (totalTimeTaken / 1000).toFixed(2) + " seconds").green.bold.toString());
    log();
    ...
    xwRoot.writeAttribute('failures', failCount.toString());
    xwRoot.writeAttribute('time', (totalTimeTaken / 1000).toFixed(2).toString());
    xwRoot.writeAttribute('errors', errorCount.toString());
    xwRoot.writeAttribute('skipped', skipCount.toString());
    xwRoot.writeAttribute('tests', totalCount.toString());
