...
SeleniumDriver.prototype.createDriverJs = function (testParams, callback) {
    ...
    martiniClientSeedJs = fs.readFileSync(path.join(self.config["arrowModuleRoot"] ,"tmp", self.config["clientConfigName"]), "utf-8");
...
//        }
    ...
    driverJs =
        ...
        "ARROW.onSeeded = function() { " + martiniClientSeedJs + testLibsJs + runnerJs + " };" + seedJs;
