...
SeleniumDriver.prototype.navigate = function (page, callback) {
    var self = this,
        ...
        url;
    console.log('***In navigate 1');
    self.logger.info("Loading page : " + page);

    console.log('***In navigate 2');
    ...
    if (false === url) {
        ...
        //    self.maximizeBrowser(webdriver);
...
SeleniumDriver.prototype.executeAction = function (testConfig, testParams, callback) {
    ...
    this.createDriverJs(testParams, function (err, driverjs) {
        ...
        driverJs = driverjs;
        if (page) {
            self.logger.info("Loading page XX : " + page);
...
//        self.maximizeBrowser(webdriver);
        ...
        if (page && testParams.customController === false) {
            ...
            self.logger.info("Loading page YY: " + page);
...
//SeleniumDriver.prototype.maximizeBrowser = function (webdriver) {
//    console.log('****In maximizeBrowser : ');
//    console.log('****In maximizeBrowser : ' + webdriver.manage().window());
//    //Maximize the browser
////    this.logger.info('Maximizing the browser..');
//    webdriver.manage().window().maximize();
//
//}
