...
//TODO - Move this method to capabilityManager
...
//        isProxyTest = false;
//
//    //TODO - Remove extraneous debug statements
//    //TODO - Get the logic reviewed
//
//    self.logger.debug('*****self.config["browser"]::' + self.config["browser"]);
//    self.logger.debug('*****self.args["browser"]::' + self.args["browser"]);
//
...
//    }
//
//    self.logger.debug('*****isProxyTest::' + isProxyTest);
//
//    if (isProxyTest) {
//
...
//        if (self.args.reuseSession === false && caps.browserName === "reuse") {
//
//            self.logger.debug('***Reuse session is set to false...so setting browser to firefox');
//            caps.browserName = "firefox";
//            caps.version = "latest";
//
//        } else {
...
//            self.logger.debug('****BrowserInfo::' + browserInfo);
//
...
//                self.logger.debug('****self.config::' + JSON.stringify(self.config));
//                self.logger.debug('****versionKey::' + versionKey);
//                if (self.config[versionKey]) {
//                    caps.version = self.config[versionKey];
//                }
//                self.logger.debug('****browserVersion::' + caps.version);
//
//            }
//
//        }
...
//        self.logger.debug('****111 Browser name :' + caps.browserName);
//        cm = new CapabilityManager();
//        tmpCaps = cm.getCapability(self.config.capabilities, caps.browserName);
//        if (tmpCaps === null) {
...
//    }
//
//    self.logger.debug('*****Browser name:' + caps.browserName);
//
//    return caps;
//
//};
