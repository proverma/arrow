            ...
            if (report && report !== "{}") {
                ...
                showYUIConsoleLog(function () {
                    self.errorCallback(logger, "Test Timed Out. It can happen due to one of these three reasons :" +
                        ...
                        "\n" +
                        "2) The page got redirected before completing the test, this happens if your page has auti-redirects, or your tests perform some UI action resulting into page change event. Please use a custom controller for these kind of issues. " +
                        "\n" +
