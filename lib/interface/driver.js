...
Driver.prototype.executeAction = function (testConfig, testArgs, callback) {
    console.log('***In driver executeAction');
...
Driver.prototype.executeTest = function (testConfig, testArgs, callback) {
    console.log('***In driver executeTest');
...
Driver.prototype.getWebDriver = function (errorCallback) {
    console.log('***In driver getWebDriver');
    if (null === this.webdriver) {
        this.logger.debug("WebDriver is not initialized or not supported");
    }
...
Driver.prototype.setSessionId = function (id) {
    console.log('***In driver setSessionId:' + id);
    this.sessionId = id;
};

Driver.prototype.getArrowServerBase = function () {
    console.log('***In driver getArrowServerBase:');
    var statusFile,
        serverUrl;
...
Driver.prototype.getRemoteUrl = function (file) {
    console.log('***In driver getRemoteUrl');
    var base,
        path,
        url;
...
Driver.prototype.addReport = function (report, caps) {
    console.log('***In driver addReport');
    var reportJson, rm;
...
Driver.prototype.getReports = function () {
    console.log('***In driver getReports');
...
Driver.prototype.errorCallback = function (logger, error, callback) {
    console.log('***In driver errorCallback: ' + error);
    logger.error(error);
    callback(error, null);
};
