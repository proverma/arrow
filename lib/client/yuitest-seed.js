...
(function () {
    ...
    function onYUIAvailable() {
        ...
        /**
         We disable yui test runner 'run' method here to let arrow take control when to start run tests.
        ...
        YUI().use('test', function (Y) {
            if (!YUITest.TestRunner.origin_run) {
                YUITest.TestRunner.origin_run = YUITest.TestRunner.run;
                YUITest.TestRunner.run = function () {
                };
            }
            ARROW.onSeeded();
        });
