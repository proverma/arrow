...
if ((typeof process !== "undefined") && (typeof require !== "undefined")) {
	...
	function loadjasmine(){
		console.log("load jasmine html");
		loadScript("http://ydn.zenfs.com/yahoo-arrow/container/jasmine/vendor/jasmine-1.2.0/jasmine-html.js",function(){
	...
	loadScript("http://ydn.zenfs.com/yahoo-arrow/container/jasmine/vendor/jasmine-1.2.0/jasmine.js",function(){
		console.log(window.jasmine);
		loadjasmine();
	});
