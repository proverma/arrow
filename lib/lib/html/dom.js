...
YUI.add("dom-lib", function (Y) {
    ...
    ArrowAsserts = {
        ...
        */
        ...
        /**
        * Verify if dom node contains valid images
        *
        * @method areImages
        * @param {String|Node} node Node/Selector for parent of images
        * @param {String} message Message to return in case of failure
        */
        areImages : function (node, message) {
            var images = getNode(node).all('img');
