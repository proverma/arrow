...
var
    ...
    Y,
    chai,
    warnOnly = testParams["warnOnly"] || false;

describe('markup-common-tests', function(){
    describe('#indexOf()', function(){
        ...
        it('markup result test', function(done){
...
//      pink   = '\u001b[35m',
            ...
            if(Y.one('table:not([summary])')) {
                error.push({level: 'warn', text: 'Table without summary.'});
            }
            ...
            if(error.length > 0) {
                ...
                for(i; i < error.length; i += 1) {
                    ...
                    if(!warnOnly) {
                        chai.assert.notEqual('error', error[i]['level'], error[i]['text']);
                    }
                }
                console.log(aqua + '=========================================================================' + reset);
            }
