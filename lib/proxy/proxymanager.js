...
ProxyManager.prototype.getOptions = function (router, request) {
    ...
    reqHost = (objUrl.host.match(/:/g) ) ? objUrl.host.slice(0, objUrl.host.indexOf(":")) : objUrl.host;
    options = {
        host: reqHost,
...
//                            else if (isHtml(request, proxy_response)) {
//
//                                function changeIframeSrc(err, code) {
//
//                                    if (err) {
//                                        self.logger.error('decompress code error:' + err);
//                                        response.write(responseStr, 'binary');
...
////                                        response.write(responseStr.replace("http://search.yahoo.com", "http://10.82.130.207:8666/"), 'binary');
//                                        response.write(responseStr, 'utf8');
...
//                                switch (proxy_response.headers['content-encoding']) {
//                                    case 'gzip':
//                                        zlib.unzip(Buffer.concat(buffers), changeIframeSrc);
//                                        break;
//                                    case 'deflate':
//                                        zlib.inflate(Buffer.concat(buffers), changeIframeSrc);
//                                        break;
//                                    default:
//                                        changeIframeSrc(null, Buffer.concat(buffers));
//                                        break;
//                                }
//                            }
                        else {
