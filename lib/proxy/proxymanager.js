                ...
                self.proxyServer = http.createServer(function (request, response) {
                    ...
                    if (url.parse(request.url).pathname === '/proxyCoverage') {
                        if (request.method === 'OPTIONS') {
                            ...
                            // get coverage status
                            if(request.params && request.params['reset']=="yes"){
                                self.logger.debug('get client sent coverage GET request from ' + request.headers['referer']+"add params is:"+request.params['reset']);
                                testFinsihed = false;
                            }
