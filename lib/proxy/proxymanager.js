        ...
        portchecker.getFirstAvailable(minPort, maxPort, host, function (p, host) {
            ...
            if (p === -1) {
                ...
                self.proxyServer = http.createServer(function (request, response) {
                    ...
                    proxy_config.passThroughUrls = ['http://yui.yahooapis.com/3.4.1/build/yui/yui-min.js'];
                    ...
                    proxy_request = http.request(options, function (proxy_response) {
                        ...
                        var needsInstrumentation = isJs(request, proxy_response) && proxy_config.passThroughUrls.indexOf(request.url) == -1;
                        var responseStr = "";
