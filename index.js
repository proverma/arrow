...
function showHelp() {
    console.info("\nOPTIONS :" + "\n" +
        ...
        "        --proxyConfig : (optional) filePath. Expects a Json file, in \"router\" object allows users to modify host and headers for all calls being made by browser. Also supports recording of select url calls." + "\n" +
