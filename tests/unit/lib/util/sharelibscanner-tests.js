                ...
                self.resume(function () {
                    ...
                    fs.readdir(metaPath, function (err, list) {
                        self.resume(function () {
                            ...
                            libs = sharelibScanner.scannerUtil.getSrcDependencyByPath(__dirname + '/sharelibtestdata/martini_lib/lib/common/mymartini.common.js', 'client');
                            Y.Assert.isTrue(libs != null && libs.yuiDepLibs.length > 0 && libs.shareDepLibs.length > 0, 'should not get empty object');
                            libs = sharelibScanner.scannerUtil.getSrcDependencyByPath(__dirname + '/sharelibtestdata/martini_lib/lib/client/errormartini.client.js', 'client');
                            Y.Assert.isTrue(libs != null, 'should not get empty object');
                            libs = sharelibScanner.scannerUtil.getSrcDependencyByPath(__dirname + '/sharelibtestdata/common_lib/yui-common-lib.js', 'client');
                            Y.Assert.isTrue(libs != null && libs.urlDepLibs.length > 0, 'should not get empty object');
