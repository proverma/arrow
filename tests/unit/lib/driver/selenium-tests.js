...
//        },
        ...
        'test createDriverJs with bad testJs': function () {
            var self = this,
                driver,
                config = {browser: 'mybrowser', seleniumHost: 'http://wdhub',testRunner: arrowRoot + '/lib/client/yuitest-runner.js', testSeed: arrowRoot + '/lib/client/yuitest-seed.js', shareLibMetaPath: arrowRoot + '/tests/unit/stub/', clientConfigName : 'client_seed.js'},
