...
//for yui sandbox
config.useYUISandbox = false;  // when this is set to true,arrow will use self-defined YUI instead of the YUI on (or injected on) the page.
...
config.clientSideCoverage=false;
