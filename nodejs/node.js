...
var yuisandbox = require('./yui-sandbox');

;(function () {

    /*
       Since this js was run in clild process . not sure if we need this isoluted yui,
       but in case it use other YUI, and has conflict modules or version ,here we get a total new one
     */
    // prepare a isolated YUI
//    YUI;

    YUI = yuisandbox.getYUI();
